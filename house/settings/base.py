...
SECRET_KEY = 'ep_xf95=5-4-*wnq)x29!yqf5uwt2%nt%s#y*4#&tz#nal32+x'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    '%s.base.context_processors.base' % PROJECT_MODULE,
)
